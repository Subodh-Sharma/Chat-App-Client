...
import { Box,useDisclosure,Modal,ModalOverlay,ModalContent,ModalHeader,ModalCloseButton,ModalBody,ModalFooter,Button, useToast, FormControl, Input } from '@chakra-ui/react';
...
const GroupChatModal = ({children}) => {
  ...
  const handleSubmit = async()=>{
    ...
    try{
      ...
      const {data} = await axios.post("https://subodh-chat-app-server.vercel.app/api/chat/group",{
        name: groupChatName,
